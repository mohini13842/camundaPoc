...
@Component
public class FetchMetaDataDelegate implements JavaDelegate {

	private final Logger LOGGER = Logger.getLogger(FetchMetaDataDelegate.class.getName());

	@Autowired
	private FetchMetaDataRepo fetchDataRepo;

	@Autowired
	private FetchMetaDataService fetchService;
